...
class RideEntity extends Equatable {
  ...
  static RideEntity fromSnapshot(DocumentSnapshot snapshot) {
    return RideEntity(
      snapshot.data['actual_dropoff_time'] as Timestamp,
      snapshot.data['actual_pickup_time'] as Timestamp,
      snapshot.data['driver_cancelled'] as bool,
      snapshot.data['driver_comments'] as String,
      snapshot.data['driver_marked_completion'] as bool,
      snapshot.data['driver_rating_of_rider'] as double,
      snapshot.data['dropoff_location'] as GeoPoint,
      snapshot.data['pickup_location'] as GeoPoint,
      snapshot.data['request_time'] as Timestamp,
      snapshot.data['rider_cancelled'] as bool,
      snapshot.data['rider_comments'] as String,
      snapshot.data['rider_marked_completion'] as bool,
      snapshot.data['rider_rating_of_driver'] as double,
      snapshot.data['rider_reached_destination'] as bool,
      snapshot.data['scheduled_dropoff_time'] as Timestamp,
      snapshot.data['scheduled_pickup_time'] as Timestamp,
      snapshot.documentID,
    );
  }
